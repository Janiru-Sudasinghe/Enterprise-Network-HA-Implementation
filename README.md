...
![Virtualization](https://img.shields.io/badge/Virtualization-VMware_ESXi-orange)
...
*(Note: Upload a screenshot of your diagram here)*
...
* **Server:** VMware ESXi Host running Windows Server 2019
...
* **Hybrid Cloud Setup:** Integrated physical network with VMware ESXi.
...
| Rack Setup | Cabling Detail |
|:---:|:---:|
| <img src="./images/Rack-Setup-Front.jpg" width="300"> | <img src="./images/Cabling-Rear.jpg" width="300"> |
| *Physical Hardware Stack* | *Ethernet & Console Connections* |
